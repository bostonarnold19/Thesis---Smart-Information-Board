...
<?php 
 if(isset($_GET['id']))
  {
  $viewId=$_GET['id'];
  $sql = "SELECT * FROM tbl_feedback WHERE id='$viewId'";
...
<body class="cbp-spmenu-push">
    <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <a data-dialog="somedialog"><i class="fa fa-power-off"></i>&nbspLog out</a>a>  
    </nav>
...
<form method="post">
          ...
          <label>Subject</label>
          <input type="text" name="subject" readonly value="<?php echo $subject?>"/>
