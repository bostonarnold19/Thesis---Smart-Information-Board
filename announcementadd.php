...
$sql=mysqli_query($dbc,"INSERT into tbl_announcement(title, content, announcementDate, summary, file) values('$title','$content','$announcementDate','$summary','$file')");
...
<div class="announcementForm">
   ...
   <form method="post" action="announcementadd.php" enctype="multipart/form-data">
          ...
          <label>Summary</label>
          <textarea name="summary" style="height: 100px;" required></textarea>
